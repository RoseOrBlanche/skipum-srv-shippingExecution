...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.ServiceSubTypes ServiceSubTypes}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ServiceSubTypesField<FieldT >
    extends EntityField<ServiceSubTypes, FieldT>
    implements ServiceSubTypesSelectable
{
     ...
     */
    public ServiceSubTypesField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public ServiceSubTypesField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

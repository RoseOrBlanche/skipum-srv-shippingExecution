...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.ContentFeeds ContentFeeds}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ContentFeedsField<FieldT >
    extends EntityField<ContentFeeds, FieldT>
    implements ContentFeedsSelectable
{
     ...
     */
    public ContentFeedsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public ContentFeedsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

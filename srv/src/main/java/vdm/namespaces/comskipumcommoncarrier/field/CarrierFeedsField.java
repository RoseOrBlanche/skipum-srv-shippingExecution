...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.CarrierFeeds CarrierFeeds}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CarrierFeedsField<FieldT >
    extends EntityField<CarrierFeeds, FieldT>
    implements CarrierFeedsSelectable
{
     ...
     */
    public CarrierFeedsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CarrierFeedsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

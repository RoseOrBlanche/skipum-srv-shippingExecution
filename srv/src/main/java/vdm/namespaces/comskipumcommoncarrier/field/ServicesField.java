...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.Services Services}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ServicesField<FieldT >
    extends EntityField<Services, FieldT>
    implements ServicesSelectable
{
     ...
     */
    public ServicesField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public ServicesField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

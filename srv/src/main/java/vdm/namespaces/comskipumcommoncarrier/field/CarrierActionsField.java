...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.CarrierActions CarrierActions}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CarrierActionsField<FieldT >
    extends EntityField<CarrierActions, FieldT>
    implements CarrierActionsSelectable
{
     ...
     */
    public CarrierActionsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CarrierActionsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

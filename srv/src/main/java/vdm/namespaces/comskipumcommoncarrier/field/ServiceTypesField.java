...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.ServiceTypes ServiceTypes}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ServiceTypesField<FieldT >
    extends EntityField<ServiceTypes, FieldT>
    implements ServiceTypesSelectable
{
     ...
     */
    public ServiceTypesField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public ServiceTypesField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.Carriers Carriers}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CarriersField<FieldT >
    extends EntityField<Carriers, FieldT>
    implements CarriersSelectable
{
     ...
     */
    public CarriersField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CarriersField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

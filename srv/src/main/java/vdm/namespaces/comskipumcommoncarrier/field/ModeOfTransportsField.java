...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncarrier.ModeOfTransports ModeOfTransports}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ModeOfTransportsField<FieldT >
    extends EntityField<ModeOfTransports, FieldT>
    implements ModeOfTransportsSelectable
{
     ...
     */
    public ModeOfTransportsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public ModeOfTransportsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

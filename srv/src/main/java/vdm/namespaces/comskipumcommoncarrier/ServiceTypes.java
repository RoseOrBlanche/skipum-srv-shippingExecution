...
import vdm.namespaces.comskipumcommoncarrier.field.ServiceTypesField;
import vdm.namespaces.comskipumcommoncarrier.selectable.ServiceTypesSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>ServiceTypes</b></p>
 * 
 */
@Builder
@Data
...
public class ServiceTypes
    extends VdmEntity<ServiceTypes>
{

    /**
     * Selector for all available fields of ServiceTypes.
     * 
     */
    public final static ServiceTypesSelectable ALL_FIELDS = new ServiceTypesSelectable() {
     ...
     * 
     */
    public final static ServiceTypesField<String> NAME = new ServiceTypesField<String>("name");
    /**
     ...
     * 
     */
    public final static ServiceTypesField<String> CODE = new ServiceTypesField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<ServiceTypes> getType() {
     ...
     */
    @Nonnull
    public static<T >ServiceTypesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new ServiceTypesField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >ServiceTypesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new ServiceTypesField<T>(fieldName, typeConverter);
    }

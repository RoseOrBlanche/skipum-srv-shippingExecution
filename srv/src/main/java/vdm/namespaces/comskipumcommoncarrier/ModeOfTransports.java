...
import vdm.namespaces.comskipumcommoncarrier.field.ModeOfTransportsField;
import vdm.namespaces.comskipumcommoncarrier.selectable.ModeOfTransportsSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>ModeOfTransports</b></p>
 * 
 */
@Builder
@Data
...
public class ModeOfTransports
    extends VdmEntity<ModeOfTransports>
{

    /**
     * Selector for all available fields of ModeOfTransports.
     * 
     */
    public final static ModeOfTransportsSelectable ALL_FIELDS = new ModeOfTransportsSelectable() {
     ...
     * 
     */
    public final static ModeOfTransportsField<String> NAME = new ModeOfTransportsField<String>("name");
    /**
     ...
     * 
     */
    public final static ModeOfTransportsField<String> CODE = new ModeOfTransportsField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<ModeOfTransports> getType() {
     ...
     */
    @Nonnull
    public static<T >ModeOfTransportsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new ModeOfTransportsField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >ModeOfTransportsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new ModeOfTransportsField<T>(fieldName, typeConverter);
    }

...
import vdm.namespaces.comskipumcommoncarrier.field.ContentActionsField;
import vdm.namespaces.comskipumcommoncarrier.selectable.ContentActionsSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>ContentActions</b></p>
 * 
 */
@Builder
@Data
...
public class ContentActions
    extends VdmEntity<ContentActions>
{

    /**
     * Selector for all available fields of ContentActions.
     * 
     */
    public final static ContentActionsSelectable ALL_FIELDS = new ContentActionsSelectable() {
     ...
     * 
     */
    public final static ContentActionsField<String> NAME = new ContentActionsField<String>("name");
    /**
     ...
     * 
     */
    public final static ContentActionsField<String> CODE = new ContentActionsField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<ContentActions> getType() {
     ...
     */
    @Nonnull
    public static<T >ContentActionsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new ContentActionsField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >ContentActionsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new ContentActionsField<T>(fieldName, typeConverter);
    }

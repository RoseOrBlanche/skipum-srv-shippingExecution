...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncarrier.Services Services} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncarrier.link.ServicesLink ServicesLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ServicesOneToOneLink<ObjectT extends VdmObject<?> >
    extends ServicesLink<ObjectT>
    implements OneToOneLink<Services, ObjectT>
{
     ...
     */
    public ServicesOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Services> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Services>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

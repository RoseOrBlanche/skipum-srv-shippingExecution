...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncarrier.Carriers Carriers} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncarrier.link.CarriersLink CarriersLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CarriersOneToOneLink<ObjectT extends VdmObject<?> >
    extends CarriersLink<ObjectT>
    implements OneToOneLink<Carriers, ObjectT>
{
     ...
     */
    public CarriersOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Carriers> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Carriers>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

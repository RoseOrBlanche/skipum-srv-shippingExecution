...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncarrier.ServiceTypes ServiceTypes} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncarrier.link.ServiceTypesLink ServiceTypesLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ServiceTypesOneToOneLink<ObjectT extends VdmObject<?> >
    extends ServiceTypesLink<ObjectT>
    implements OneToOneLink<ServiceTypes, ObjectT>
{
     ...
     */
    public ServiceTypesOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ServiceTypes> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<ServiceTypes>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncarrier.CarrierFeeds CarrierFeeds} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncarrier.link.CarrierFeedsLink CarrierFeedsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CarrierFeedsOneToOneLink<ObjectT extends VdmObject<?> >
    extends CarrierFeedsLink<ObjectT>
    implements OneToOneLink<CarrierFeeds, ObjectT>
{
     ...
     */
    public CarrierFeedsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CarrierFeeds> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<CarrierFeeds>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

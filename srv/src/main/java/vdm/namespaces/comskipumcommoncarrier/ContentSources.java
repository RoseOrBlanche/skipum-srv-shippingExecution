...
import vdm.namespaces.comskipumcommoncarrier.field.ContentSourcesField;
import vdm.namespaces.comskipumcommoncarrier.selectable.ContentSourcesSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>ContentSources</b></p>
 * 
 */
@Builder
@Data
...
public class ContentSources
    extends VdmEntity<ContentSources>
{

    /**
     * Selector for all available fields of ContentSources.
     * 
     */
    public final static ContentSourcesSelectable ALL_FIELDS = new ContentSourcesSelectable() {
     ...
     * 
     */
    public final static ContentSourcesField<String> NAME = new ContentSourcesField<String>("name");
    /**
     ...
     * 
     */
    public final static ContentSourcesField<String> CODE = new ContentSourcesField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<ContentSources> getType() {
     ...
     */
    @Nonnull
    public static<T >ContentSourcesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new ContentSourcesField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >ContentSourcesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new ContentSourcesField<T>(fieldName, typeConverter);
    }

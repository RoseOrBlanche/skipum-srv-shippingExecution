...
import vdm.namespaces.comskipumcommoncarrier.field.ServiceSubTypesField;
import vdm.namespaces.comskipumcommoncarrier.selectable.ServiceSubTypesSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>ServiceSubTypes</b></p>
 * 
 */
@Builder
@Data
...
public class ServiceSubTypes
    extends VdmEntity<ServiceSubTypes>
{

    /**
     * Selector for all available fields of ServiceSubTypes.
     * 
     */
    public final static ServiceSubTypesSelectable ALL_FIELDS = new ServiceSubTypesSelectable() {
     ...
     * 
     */
    public final static ServiceSubTypesField<String> NAME = new ServiceSubTypesField<String>("name");
    /**
     ...
     * 
     */
    public final static ServiceSubTypesField<String> CODE = new ServiceSubTypesField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<ServiceSubTypes> getType() {
     ...
     */
    @Nonnull
    public static<T >ServiceSubTypesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new ServiceSubTypesField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >ServiceSubTypesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new ServiceSubTypesField<T>(fieldName, typeConverter);
    }

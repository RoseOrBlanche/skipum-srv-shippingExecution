...
import vdm.namespaces.comskipumcommoncarrier.field.ContentFeedsField;
import vdm.namespaces.comskipumcommoncarrier.selectable.ContentFeedsSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>ContentFeeds</b></p>
 * 
 */
@Builder
@Data
...
public class ContentFeeds
    extends VdmEntity<ContentFeeds>
{

    /**
     * Selector for all available fields of ContentFeeds.
     * 
     */
    public final static ContentFeedsSelectable ALL_FIELDS = new ContentFeedsSelectable() {
     ...
     * 
     */
    public final static ContentFeedsField<String> NAME = new ContentFeedsField<String>("name");
    /**
     ...
     * 
     */
    public final static ContentFeedsField<String> CODE = new ContentFeedsField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<ContentFeeds> getType() {
     ...
     */
    @Nonnull
    public static<T >ContentFeedsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new ContentFeedsField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >ContentFeedsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new ContentFeedsField<T>(fieldName, typeConverter);
    }

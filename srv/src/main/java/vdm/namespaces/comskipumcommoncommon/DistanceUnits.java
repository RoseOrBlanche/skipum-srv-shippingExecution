...
import vdm.namespaces.comskipumcommoncommon.field.DistanceUnitsField;
import vdm.namespaces.comskipumcommoncommon.selectable.DistanceUnitsSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>DistanceUnits</b></p>
 * 
 */
@Builder
@Data
...
public class DistanceUnits
    extends VdmEntity<DistanceUnits>
{

    /**
     * Selector for all available fields of DistanceUnits.
     * 
     */
    public final static DistanceUnitsSelectable ALL_FIELDS = new DistanceUnitsSelectable() {
     ...
     * 
     */
    public final static DistanceUnitsField<String> NAME = new DistanceUnitsField<String>("name");
    /**
     ...
     * 
     */
    public final static DistanceUnitsField<String> CODE = new DistanceUnitsField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<DistanceUnits> getType() {
     ...
     */
    @Nonnull
    public static<T >DistanceUnitsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new DistanceUnitsField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >DistanceUnitsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new DistanceUnitsField<T>(fieldName, typeConverter);
    }

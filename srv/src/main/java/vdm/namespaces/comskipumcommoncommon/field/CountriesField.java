...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncommon.Countries Countries}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CountriesField<FieldT >
    extends EntityField<Countries, FieldT>
    implements CountriesSelectable
{
     ...
     */
    public CountriesField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CountriesField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

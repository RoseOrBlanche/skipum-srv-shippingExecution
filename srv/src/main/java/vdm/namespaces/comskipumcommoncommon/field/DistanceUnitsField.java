...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncommon.DistanceUnits DistanceUnits}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class DistanceUnitsField<FieldT >
    extends EntityField<DistanceUnits, FieldT>
    implements DistanceUnitsSelectable
{
     ...
     */
    public DistanceUnitsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public DistanceUnitsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

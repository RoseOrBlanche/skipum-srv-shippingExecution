...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncommon.Currencies Currencies}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CurrenciesField<FieldT >
    extends EntityField<Currencies, FieldT>
    implements CurrenciesSelectable
{
     ...
     */
    public CurrenciesField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CurrenciesField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

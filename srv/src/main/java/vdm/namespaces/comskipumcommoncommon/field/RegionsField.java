...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncommon.Regions Regions}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class RegionsField<FieldT >
    extends EntityField<Regions, FieldT>
    implements RegionsSelectable
{
     ...
     */
    public RegionsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public RegionsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

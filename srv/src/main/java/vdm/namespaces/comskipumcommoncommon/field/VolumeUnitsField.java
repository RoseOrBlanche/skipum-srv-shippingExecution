...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.comskipumcommoncommon.VolumeUnits VolumeUnits}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class VolumeUnitsField<FieldT >
    extends EntityField<VolumeUnits, FieldT>
    implements VolumeUnitsSelectable
{
     ...
     */
    public VolumeUnitsField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public VolumeUnitsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {

...
import vdm.namespaces.comskipumcommoncommon.field.VolumeUnitsField;
import vdm.namespaces.comskipumcommoncommon.selectable.VolumeUnitsSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>VolumeUnits</b></p>
 * 
 */
@Builder
@Data
...
public class VolumeUnits
    extends VdmEntity<VolumeUnits>
{

    /**
     * Selector for all available fields of VolumeUnits.
     * 
     */
    public final static VolumeUnitsSelectable ALL_FIELDS = new VolumeUnitsSelectable() {
     ...
     * 
     */
    public final static VolumeUnitsField<String> NAME = new VolumeUnitsField<String>("name");
    /**
     ...
     * 
     */
    public final static VolumeUnitsField<String> CODE = new VolumeUnitsField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<VolumeUnits> getType() {
     ...
     */
    @Nonnull
    public static<T >VolumeUnitsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new VolumeUnitsField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >VolumeUnitsField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new VolumeUnitsField<T>(fieldName, typeConverter);
    }

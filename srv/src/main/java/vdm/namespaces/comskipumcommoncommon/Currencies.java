...
import vdm.namespaces.comskipumcommoncommon.field.CurrenciesField;
    ...
    extends VdmEntity<Currencies>
{
     ...
     * 
     */
    public final static CurrenciesSelectable ALL_FIELDS = new CurrenciesSelectable() {
     ...
     * 
     */
    public final static CurrenciesField<String> NAME = new CurrenciesField<String>("name");
    /**
     ...
     * 
     */
    public final static CurrenciesField<String> CODE = new CurrenciesField<String>("code");
    /**
     ...
     */
    @Nonnull
    public static<T >CurrenciesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new CurrenciesField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >CurrenciesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new CurrenciesField<T>(fieldName, typeConverter);
    }

...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncommon.DistanceUnits DistanceUnits} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncommon.link.DistanceUnitsLink DistanceUnitsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class DistanceUnitsOneToOneLink<ObjectT extends VdmObject<?> >
    extends DistanceUnitsLink<ObjectT>
    implements OneToOneLink<DistanceUnits, ObjectT>
{
     ...
     */
    public DistanceUnitsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<DistanceUnits> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<DistanceUnits>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

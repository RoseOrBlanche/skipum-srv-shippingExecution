...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncommon.WeightUnits WeightUnits} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncommon.link.WeightUnitsLink WeightUnitsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class WeightUnitsOneToOneLink<ObjectT extends VdmObject<?> >
    extends WeightUnitsLink<ObjectT>
    implements OneToOneLink<WeightUnits, ObjectT>
{
     ...
     */
    public WeightUnitsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<WeightUnits> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<WeightUnits>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.comskipumcommoncommon.Currencies Currencies} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.comskipumcommoncommon.link.CurrenciesLink CurrenciesLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CurrenciesOneToOneLink<ObjectT extends VdmObject<?> >
    extends CurrenciesLink<ObjectT>
    implements OneToOneLink<Currencies, ObjectT>
{
     ...
     */
    public CurrenciesOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Currencies> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Currencies>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }

...
import vdm.namespaces.comskipumcommoncommon.field.CountriesField;
import vdm.namespaces.comskipumcommoncommon.selectable.CountriesSelectable;


/**
 * <p>Original entity name from the Odata EDM: <b>Countries</b></p>
 * 
 */
@Builder
@Data
...
public class Countries
    extends VdmEntity<Countries>
{

    /**
     * Selector for all available fields of Countries.
     * 
     */
    public final static CountriesSelectable ALL_FIELDS = new CountriesSelectable() {
     ...
     * 
     */
    public final static CountriesField<String> NAME = new CountriesField<String>("name");
    /**
     ...
     * 
     */
    public final static CountriesField<String> CODE = new CountriesField<String>("code");
    /**
    ...
    @Nonnull
    @Override
    public Class<Countries> getType() {
     ...
     */
    @Nonnull
    public static<T >CountriesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final Class<T> fieldType) {
        return new CountriesField<T>(fieldName);
    }
     ...
     */
    @Nonnull
    public static<T,DomainT >CountriesField<T> field(
        @Nonnull
        final String fieldName,
        @Nonnull
        final TypeConverter<T, DomainT> typeConverter) {
        return new CountriesField<T>(fieldName, typeConverter);
    }
